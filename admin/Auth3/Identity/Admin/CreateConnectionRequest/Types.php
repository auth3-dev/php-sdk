...
/**
 * Protobuf type <code>depot.devtools.auth.v0.identity.admin.CreateConnectionRequest.Types</code>
 */
class Types
{
    /**
...
class_alias(Types::class, \Auth3\Identity\Admin\CreateConnectionRequest_Types::class);
