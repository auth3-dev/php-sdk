# Auth3 Identity Platform | PHP SDK examples

This repository contains an example application that uses the [Auth3](https://auth3.dev) [PHP SDK](https://github.com/auth3-dev/php-sdk).

Make sure to check-out our [documentation](https://docs.auth3.dev/apis/identity-platform/administrative) to learn more about the available APIs and their request/response models.
